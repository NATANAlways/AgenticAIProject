...
class AINewsNode:
    def __init__(self, llm):
        ...
        # this is used to capture various steps in theos files so that later can be used for steps shown
        self.state = {}
    ...
    def fetch_news(self, state: dict) -> dict:
        ...
        Returns:
            dict: Updated state with 'news_data' key containig fetched news.
        """
    ...
    def summarize_news(self, state: dict) -> dict:
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            ("system", """Summarize AI news articles into markdown format. For each item include:
             ...
             -Concise sentences summary from lates news
